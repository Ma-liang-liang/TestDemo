...
SWIFT_CLASS("_TtC14ZLPhotoBrowser19ZLBaseStickertState")
...
- (ZLCameraConfiguration * _Nonnull)overlayView:(UIView * _Nonnull)value;
...
- (ZLEditImageConfiguration * _Nonnull)showClipDirectlyIfOnlyHasClipTool:(BOOL)value;
...
@property (nonatomic, strong) ZLPassThroughView * _Nonnull topShadowView;
@property (nonatomic, strong) CAGradientLayer * _Nonnull topShadowLayer;
@property (nonatomic, strong) ZLPassThroughView * _Nonnull bottomShadowView;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSArray<ZLImageClipRatio *> * _Nonnull all;)
+ (NSArray<ZLImageClipRatio *> * _Nonnull)all SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, strong) id <ZLImagePreviewControllerDelegate> _Nullable delegate;
...
@interface ZLImagePreviewController (SWIFT_EXTENSION(ZLPhotoBrowser)) <UIViewControllerTransitioningDelegate>
...
@protocol ZLImagePreviewControllerDelegate
@optional
- (void)imagePreviewController:(ZLImagePreviewController * _Nonnull)controller willDisplay:(UICollectionViewCell * _Nonnull)cell forItemAt:(NSIndexPath * _Nonnull)indexPath;
- (void)imagePreviewController:(ZLImagePreviewController * _Nonnull)controller didEndDisplaying:(UICollectionViewCell * _Nonnull)cell forItemAt:(NSIndexPath * _Nonnull)indexPath;
- (void)imagePreviewController:(ZLImagePreviewController * _Nonnull)controller didScroll:(UICollectionView * _Nonnull)collectionView;
@end
...
SWIFT_CLASS("_TtC14ZLPhotoBrowser17ZLPassThroughView")
@interface ZLPassThroughView : UIView
...
/// Save image to album.
+ (void)saveImageToAlbumWithImage:(UIImage * _Nonnull)image completion:(void (^ _Nullable)(NSError * _Nullable, PHAsset * _Nullable))completion;
/// Save video to album.
...
- (void)layoutSubviews;
/// warning:
/// When calling this method in OC language, make sure that the <code>sender</code> is not zero
...
@property (nonatomic) BOOL shouldCenterTools;
...
@interface ZLProgressHUD (SWIFT_EXTENSION(ZLPhotoBrowser))
@end

typedef SWIFT_ENUM_NAMED(NSInteger, ZLProgressHUDStyle, "Style", closed) {
