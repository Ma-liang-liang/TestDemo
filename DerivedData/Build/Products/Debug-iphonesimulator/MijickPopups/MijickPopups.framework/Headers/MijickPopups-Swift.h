...
#ifndef MIJICKPOPUPS_SWIFT_H
#define MIJICKPOPUPS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MijickPopups",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///
/// \endcodeseealso:
/// It’s also possible to register the framework with <code>SwiftUICore/View/registerPopups(id:configBuilder:)</code>.
SWIFT_CLASS("_TtC12MijickPopups18PopupSceneDelegate")
@interface PopupSceneDelegate : NSObject <UIWindowSceneDelegate>
...
@interface PopupSceneDelegate (SWIFT_EXTENSION(MijickPopups))
